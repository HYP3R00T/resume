...
#experience(
  ...
  [],
  [
    - Built a secure, production-grade *Kubernetes* cluster with *GitOps* via *FluxCD* and *Helm*, improving deployment reliability and eliminating manual workflows.
    - Integrated *HashiCorp Vault* with *External Secrets Operator* to manage secrets securely, enforcing zero Git exposure.
    - Automated cross-platform environment setup using *Ansible*, *mise-en-place*, *chezmoi*, and *Bash scirpts*, reducing onboarding time from *6 hours to under 10 minutes*.
  ],
)
#experience(
  [Wipro Ltd.],
